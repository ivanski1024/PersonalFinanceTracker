...
const makeExpenses = (): Expense[] => [
  ...
  { id: '2', description: 'Groceries', amount: 30, category: 'Shopping' },
  { id: '3', description: 'Salary', amount: 1000, category: 'Job' },
]

// --- Table structure ---

describe('table structure', () => {
  it('displays Name, Amount, and Category column headers', async () => {
